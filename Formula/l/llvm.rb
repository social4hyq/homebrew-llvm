class Llvm < Formula
  desc "LLVM toolchain for HarmonyOS (clang + lld + OHOS multiarch runtime libs for aarch64-linux-ohos)"
  ...
  bottle do
    ...
    sha256 cellar: :any_skip_relocation, arm64_ohos: "31c462502be25be63837960e7e8f599599e7ef50a39ae6daa332a83ed4f26e60"
  end

  keg_only "this is a HarmonyOS bootstrap toolchain that targets aarch64-linux-ohos by default"
